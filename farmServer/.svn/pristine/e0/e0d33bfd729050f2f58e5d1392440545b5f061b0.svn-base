...
public class MD5
{
    ...
    public String getMD5ofStr(String inbuf, String encode) {
        md5Init();
        try {
            byte[] data = inbuf.getBytes(encode);
...
/* Location:           /Users/toswf/Documents/修改过的5kw包/5kw-framework-util.jar
 * Qualified Name:     com.ssd.framework.secu.MD5
